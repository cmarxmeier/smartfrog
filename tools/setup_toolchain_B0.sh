...
# Extract the archive
# tar xzf Hi3518_SDK_V1.0.B.0.tgz

# Specify bash as many modern systems default to dash, which doesn't work
sed -i 's/bin\/sh/bin\/bash/' Hi3518_SDK_V1.0.B.0/sdk.unpack

# Unpack the SDK
cd Hi3518_SDK_V1.0.B.0 && ./sdk.unpack
