...
cd dropbear-2016.74/ && ./configure --host=arm-hisiv100nptl-linux --prefix=/ --sysconfdir=/app/wifi/tools --disable-zlib CC=arm-hisiv100nptl-linux-gcc LD=arm-hisiv100nptl-linux-ld && make PROGRAMS="dropbear dbclient scp" MULTI=1
